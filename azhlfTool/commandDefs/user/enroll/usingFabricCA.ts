...
export const command = "usingFabricCA";
export const desc = "Enroll user using Fabric CA.";
...
export const handler = async (argv: Arguments): Promise<void> => {
    try {
        await new ImportUserCommandHandler().EnrollUserUsingFabricCA(argv.organization, argv.username, argv.secret);
    } catch (error) {
        console.error(error);
    }
};
